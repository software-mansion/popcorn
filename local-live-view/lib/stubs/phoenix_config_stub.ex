# Stub: AtomVM doesn't support :ets.select nor :ets.match_delete,
# that is used by `update/3` and `clear_cache/1`. These functions are
# patched, the rest is untouched.
