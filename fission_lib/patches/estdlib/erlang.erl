...
%% @param   Args Parameters to pass to function (max 32)
...
spawn(Function) ->
    simple_trace_proc:trace(erlang:spawn_opt(Function, [])).
...
spawn(Module, Function, Args) ->
    simple_trace_proc:trace(erlang:spawn_opt(Module, Function, Args, [])).
...
spawn_link(Function) ->
    simple_trace_proc:trace(erlang:spawn_opt(Function, [link])).
...
spawn_link(Module, Function, Args) ->
    simple_trace_proc:trace(erlang:spawn_opt(Module, Function, Args, [link])).
