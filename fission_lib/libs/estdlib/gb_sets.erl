...
% It seems that p = 2 is optimal for sorted keys
-define(p, 2).

% correct with exponent as defined above.
-define(pow(A, _), A * A).
...
% 1 / ln 2; this appears to be best
-define(c, 1.46).
...
union_2(Xs, Ys, S) ->
    % S is the sum of the sizes here
    union_2(Xs, Ys, [], S).
