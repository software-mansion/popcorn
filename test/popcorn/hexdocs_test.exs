...
defmodule Popcorn.HexdocsTest do
  ...
  [
    ...
    },
    {
      ...
      Math.some_function()
      """,
      output: [:ok, :ok, :ok, :ok, :ok, :ok, :ok, :ok, :ok, :ok], tag: :skip_wasm
    },
  ...
  [
    ...
    },
    {
      ...
      output: "3315715A7A3AD57428298676C5AE465DADA38D951BDFAC9348A8A31E9C7401CB", tag: :skip_wasm
    },
    {
      """
      digraph = :digraph.new()
