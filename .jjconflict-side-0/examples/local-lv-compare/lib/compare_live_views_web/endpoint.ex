defmodule CompareLiveViewsWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :compare_live_views
  ...
  @session_options [
    store: :cookie,
    key: "_compare_live_views_key",
    signing_salt: "f1aNsQ/u",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :compare_live_views,
    gzip: not code_reloading?,
    only: CompareLiveViewsWeb.static_paths(),
