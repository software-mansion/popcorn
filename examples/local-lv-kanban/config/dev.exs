...
config :local_lv_kanban, LocalLvKanbanWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/local_lv_kanban_web/router\.ex$",
      ~r"lib/local_lv_kanban_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :local_lv_kanban, dev_routes: true
