defmodule LocalLvKanbanWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_local_lv_kanban_key",
    signing_salt: "hBVCHx+V",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :local_lv_kanban,
    gzip: not code_reloading?,
    only: LocalLvKanbanWeb.static_paths(),
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :local_lv_kanban
  end
