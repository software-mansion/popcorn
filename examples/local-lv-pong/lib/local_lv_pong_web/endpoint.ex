defmodule LocalLvPongWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :local_lv_pong
  ...
  @session_options [
    store: :cookie,
    key: "_local_lv_pong_key",
    signing_salt: "VKjQNKXD",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    only: LocalLvPongWeb.static_paths(),
