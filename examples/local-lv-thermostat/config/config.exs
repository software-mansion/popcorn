...
config :local_thermostat, LocalThermostatWeb.Endpoint,
  ...
  live_view: [signing_salt: "3yi6wyIl"]
...
config :esbuild,
  ...
  local_thermostat: [
    args:
      ~w(js/app.js --bundle --format=esm --alias:local_live_view=#{Mix.Project.deps_paths()[:local_live_view]}/priv/static/local_live_view.js --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/* --alias:@=.),
